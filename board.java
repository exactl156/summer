...
public class board extends JFrame {
	...
	public final void initializeGui() {
		 ...
		 * tools.addSeparator(); tools.add(new JButton("Resign")); // TODO - add
		 * functionality! tools.addSeparator();
		 */
		// tools.add(message);
		...
		for (int ii = 0; ii < button.length; ii++) {
			for (int jj = 0; jj < button[ii].length; jj++) {
	...
	public static void main(String[] args) {
		Runnable r = new Runnable() {
			...
			public void run() {
				...
				f.setBounds(0, 0, screenWidth()/3, screenHeight()/2);
				f.setVisible(true);
			}
		};
